...
export default function HeaderControls() {
  ...
  return (
    <div className="fixed top-2 right-2 md:top-4 md:right-5 z-50 flex items-center gap-1.5 md:gap-3">
      ...
      <button
        onClick={toggleTheme}
        className="inline-flex items-center gap-1 md:gap-2 rounded-full border-2 border-black px-2.5 py-2 md:px-5 md:py-3 text-xs md:text-base font-semibold text-white bg-white/10 hover:bg-white/20 dark:bg-black/30 backdrop-blur transition"
      >
        {isDark ? (
          <svg width="16" height="16" className="md:w-5 md:h-5" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" strokeWidth="0">
            <path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z" />
          </svg>
        ) : (
          <svg width="16" height="16" className="md:w-5 md:h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
