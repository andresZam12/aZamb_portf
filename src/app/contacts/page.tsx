...
export default function ContactosPage() {
  ...
  return (
    <div className="min-h-screen text-stone-100 relative overflow-hidden">
      ...
      <span aria-hidden className="absolute inset-0 -z-10 bg-[linear-gradient(to_right,#3b2a23_0%,#3b2a23_33.34%,#8b5e3c_33.34%,#8b5e3c_66.67%,#c48758_66.67%,#c48758_100%)]"></span>
      {/* Barra vertical decorativa al centro */}
      <span aria-hidden className="absolute inset-y-0 left-1/2 -translate-x-1/2 w-1 md:w-1.5 bg-black/25 rounded-full -z-0"/>
      {/* Etiqueta superior */}
          ...
          <aside className="col-span-12 md:col-span-6">
            <ul className="space-y-6">
              ...
              <li className="flex items-center gap-4">
                <span className="grid place-items-center w-10 h-10 rounded-md bg-white/10 ring-1 ring-white/15">
                  ...
                  <svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor" className="text-red-400">
                    ...
                    <path d="M22 6V6a2 2 0 00-2-2H4a2 2 0 00-2 2v.75L12 13.5 22 6.75V6z" className="fill-red-500" />
                  </svg>
                </span>
                <a href="mailto:andresze2001@gmail.com" className="text-lg font-semibold hover:underline">
              ...
              <li className="flex items-center gap-4">
                <span className="grid place-items-center w-10 h-10 rounded-md bg-white/10 ring-1 ring-white/15">
                  {/* ícono WhatsApp */}
                  <svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor" className="text-green-400">
                    <path d="M20 11.5A8.5 8.5 0 115.4 18.6L4 22l3.5-1.4A8.5 8.5 0 1120 11.5z" />
                  </svg>
                </span>
                <a href="https://wa.me/57317799202" target="_blank" rel="noreferrer" className="text-lg font-semibold hover:underline">
                  317799202
                </a>
              </li>
              ...
              <li className="flex items-center gap-4">
                ...
                <a href="https://www.linkedin.com/in/andres_z8" target="_blank" rel="noreferrer" className="text-lg font-semibold hover:underline">
                  andres_z8
                </a>
              </li>
              ...
              <li className="flex items-center gap-4">
                ...
                <a href="https://github.com/andres_z8" target="_blank" rel="noreferrer" className="text-lg font-semibold hover:underline">
                  GitHub
                </a>
              </li>
            </ul>
            ...
            {/* Lema */}
            <p className="mt-10 italic text-center text-sm opacity-90">“si lo puedes imaginar, lo podemos hacer”</p>
          </aside>
      ...
      <nav className="fixed bottom-6 right-6 z-40 flex gap-2">
        ...
        <a href="/" className="grid place-items-center w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 ring-1 ring-white/15 shadow">
